...
%比较两个算法的不同，第一组trainlm +traingda；第二组traingdm+trainbfg
...
t=y;% Targets. Change to yn to train on noisy data改变噪音
%ex2_Learning from noisy data: generalization: change t=y to t=yn 

%%

%creation of networks创建网络
